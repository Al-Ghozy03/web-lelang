        ...
        <div className="flex">
          ...
          <div className="flex flex-col w-full pr-24">
            ...
            <div className="pl-20 mt-10 flex space-x-36">
                  ...
                  <div className="flex space-x-4">
                    <div className="">
                      ...
                      <button
                        ...
                        className="text-sm px-5 py-1 bg-red-600 relative rounded-md transition ease-in-out hover:scale-110"
                      >
                        Cancel
                      </button>
                    </div>
                    <div>
                      ...
                      <button
                        onClick={updateImage}
                        className="text-sm relative px-5 py-1 bg-blue-theme rounded-md transition ease-in-out hover:scale-110"
                      >
                        Update
                      </button>
                    </div>
              ...
              <div className="">
                <h1 className="text-2xl mb-5 font-semibold text-[#A6A6A6]">
                  Profile
                </h1>
