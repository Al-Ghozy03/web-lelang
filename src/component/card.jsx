    ...
    <React.Fragment>
      ...
      >
        <div
          ...
          className="h-1/2 rounded-lg w-full bg-gray-700 bg-cover"
        ></div>
        <div className="mt-3 flex flex-col">
          ...
          <div className="flex justify-end">
            <div className="mt-3 transition ease-in-out hover:scale-110">
              <div className="bg-blue-theme h-7 w-16 text-sm px-5 font-semibold py-1 rounded-md absolute blur opacity-60"></div>
              <button
